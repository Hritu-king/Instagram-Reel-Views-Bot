...
username= "yfyt211" #Instagram Username
password= "205717252" #Instagram Password
...
try:
	...
	for i in range(1000): #Number of views
            driver.get("https://www.instagram.com/reel/CtF0Q3mxY19/") #Reel link
